...
from detectron2.evaluation import COCOKPSEvaluator, verify_results
from detectron2.solver.build import maybe_add_gradient_clipping

from querypose import SparseRCNNDatasetMapper, add_querypose_config
...
#     """
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        return COCOKPSEvaluator(dataset_name, cfg, True, output_folder)
